                ...
                if(($row['course_id']) == $_REQUEST['checkid']){
                   ...
                   <?php
                    ...
                    echo '<td>
                        ...
                        </form>  <a  class="delete-confirm btn btn-secondary" href="lessons.php?id='.$row["lesson_id"].'"><i class="fas fa-trash"></i></a>
...
if(isset($_GET['id'])){
    ...
    $sql = "DELETE FROM lesson WHERE lesson_id ='$delete_id'";
    $result = $conn->query($sql);
    if($conn->query($sql) == TRUE){
        echo '<meta http-equiv="refresh" content="0;URL=?deleted" />';
    } else {
