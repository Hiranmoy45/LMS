...
if(isset($_REQUEST['newStuSubmitBtn'])){
    ...
    if(($_REQUEST['stu_name'] == "") || ($_REQUEST['stu_email'] == "") || ($_REQUEST['stu_pass'] == "") || ($_REQUEST['stu_occ'] == "")){
       $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2">Fill All Fields</div>';
        ...
        $pass = password_hash($stu_pass, PASSWORD_BCRYPT);
 $img_folder = './image/stu/user.png';

        $sql ="INSERT INTO `student` (`stu_name`, `stu_email`, `stu_mobile`, `stu_pass`, `stu_occ`, `stu_img`, `code`, `status`,`BU`) VALUES ('$stu_name', '$stu_email', '$mobile', '$pass','$stu_occ', '$img_folder', '0', 'verified','1')";
